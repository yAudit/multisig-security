...
export const SUPPORTED_CHAINS: ChainConfig[] = [
  {
    ...
    name: 'Ethereum',
    viemChain: mainnet,
    rpcUrl: process.env.RPC_URL_ETHEREUM || 'https://eth.drpc.org',
    backupRpcUrl: 'https://mainnet.gateway.tenderly.co',
  ...
  },
  {
    ...
    name: 'Base',
    viemChain: base,
    rpcUrl: process.env.RPC_URL_BASE || 'https://base.gateway.tenderly.co',
